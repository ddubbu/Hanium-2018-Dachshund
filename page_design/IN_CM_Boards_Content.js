        ...
        <Menu.Item href='http://localhost:3000/Home' as='a' header>
         ...
         <Dropdown item simple text='Contents'>
          ...
          <Dropdown.Item href='http://localhost:3000/IN_CM_Setting_m' >기본 설정</Dropdown.Item>
            <Dropdown.Item href='http://localhost:3000/IN_CM_Boards_Content'>컨텐츠 관리</Dropdown.Item>
  ...
  <Button inverted color='olive'>
    <Card fluid='false'>
      ...
      <Grid.Column textAlign='center'>
        <Button inverted color='blue' content='모아보기' />
      </Grid.Column >

      <Grid.Column textAlign='center'>
      <Button inverted color='red' content='텍스트' />
      </Grid.Column>

      <Grid.Column textAlign='center'>
        <Button inverted color='olive' content='이미지' />
      </Grid.Column>

      <Grid.Column textAlign='center'>
        <Button inverted color='yellow' content='동영상' />
      </Grid.Column>
    </Grid>
  </Popup>
      </Card.Content>
