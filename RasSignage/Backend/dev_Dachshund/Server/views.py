...
from Server.models import Board, Content_Rotation , User, Content #api파일 내의 models.py에서 class 2개 추출해 import

#개념#
# 시리얼라이저는 가져올 Model과 1:1이 되어 Database 언어를 Python으로 바꾸어준다.
...
class User_api(GenericAPIView, mixins.ListModelMixin, mixins.CreateModelMixin,
               mixins.DestroyModelMixin, mixins.UpdateModelMixin):
...
class Content_api(GenericAPIView, mixins.ListModelMixin, mixins.CreateModelMixin,
                  mixins.DestroyModelMixin, mixins.UpdateModelMixin):
