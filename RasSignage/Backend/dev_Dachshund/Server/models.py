...
class User(models.Model):
    Init_Id = models.CharField(max_length=32, auto_created=True, primary_key=True)
    Init_Password = models.CharField(max_length=256, auto_created=True)
...
class Content_Rotation(models.Model):
    ...
    Ro_Image = models.IntegerField
    Ro_text= models.IntegerField
    Ro_video= models.IntegerField


class Content(models.Model):
    #No=models.IntegerField(auto_created=True, primary_key=True) # 컨텐츠 번호 -> 선착순
    Content_Type=(
        ('T','Text'),
        ('I','Image'),
        ('V','Video'),
    )
    content_type=models.CharField(max_length=1,choices=Content_Type,null=True,help_text='T,I,V 중 1개 선택')
